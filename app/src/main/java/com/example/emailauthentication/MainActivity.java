...
public class MainActivity extends AppCompatActivity {
    public static final int GALLERY_INTENT_CODE = 1023;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // to check user verification in app
        ...
        resetPassLocal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setMessage("Enter you New password >6 character");
                ...
                dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        user.updatePassword(newPassword).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(MainActivity.this, "Password reset failed" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
    ...
    private void uploadImageFirebase(Uri imageUri){
        //upload image to firebse storage
